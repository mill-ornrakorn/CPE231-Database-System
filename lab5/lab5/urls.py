...
urlpatterns = [
    ...
    path('receipt/list_invoice',receipt_views.ReciptListInvoice.as_view(), name='receipt_invoice_list'),
    path('receipt/list', receipt_views.ReceiptList.as_view(), name='receipt_list'),
    path('payment_method/list', receipt_views.PaymentMethodList.as_view(), name='payment_method_list'),
    path('payment_method/detail/<pk>', receipt_views.PaymentMethodDetail.as_view(), name='payment_method_detail'),
